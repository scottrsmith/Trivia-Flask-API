...
def create_or_search_question():
        ...
        **Create a new question**
        ...
        - Sample Call create question::
            ...
            curl -X POST http://localhost:5000/questions 
                 ...
                 -d '{"question":"One plus one is","answer":"2","difficulty":1,"category":1}'
    ...
    try:
        if search:
            ...
            # The request JSON is passed to be initialized by Question class's __init__
...
def retrieve_questions():
    """
        **Retrieve API Questions**
        ...
        This API will retrieve a page of 10 trivia questions sorted by question_id. 
...
#----------------------------------------------------------------------------#
#  Delete question from the databas
#----------------------------------------------------------------------------#
