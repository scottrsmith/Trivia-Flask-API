...
class Question(db.Model):  
  ...
  __columnNames__ = [('question',True),('answer',True),('category',True),('difficulty',True)]
  ...
  # The question object is dynamically updated with data from the json request object
